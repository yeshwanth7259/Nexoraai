    ...
    <div className="w-full min-h-full max-w-[1600px] mx-auto text-white px-2 sm:px-4 md:px-8 pt-6 pb-32 md:pb-12">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-9 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-[#0B0B14] rounded-[2rem] border border-white/5 p-6 md:p-8 flex-1 min-h-[250px]">
                <div className="flex items-center justify-between mb-5">
            ...
            {/* TASKS */}
            <div className="bg-[#0B0B14] rounded-[2rem] border border-white/5 p-6 md:p-8 min-h-[300px]">
              <div className="flex items-center justify-between mb-5">
        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
          ...
          {/* ACTIVITY FEED */}
          <div className="bg-[#0B0B14] rounded-[2rem] border border-white/5 p-6 md:p-8 flex-1 min-h-[300px]">
...
function StudioCard({ icon: Icon, title, desc, color, href }: any) {
  ...
  return (
    <Link href={href}>
      <div className="flex flex-col h-full bg-[#12121A] rounded-[1.5rem] border border-white/5 p-5 transition-all duration-300 hover:bg-white/5 hover:-translate-y-1 group relative overflow-hidden">
